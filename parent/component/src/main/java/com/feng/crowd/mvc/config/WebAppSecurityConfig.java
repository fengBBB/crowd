...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity security) throws Exception {
        security.authorizeRequests()
                ...
                .loginProcessingUrl("/security/do/login.html") //指定处理登录的url
                .defaultSuccessUrl("/admin/to/main/page.html") //指定成功后去的页面
                .usernameParameter("loginAcct") // 指定页面传递参数名
                .passwordParameter("userPswd")
                .and().logout()//开启退出登录
                .logoutUrl("/security/do/logout.html") //指定退出时url
                .logoutSuccessUrl("/admin/to/login/page.html") //指定退出成功后需要去的url
                ;
    }
